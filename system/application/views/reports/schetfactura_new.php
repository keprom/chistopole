...
<FONT size=7>
    <table width=100%>
        <tr align=center>
            <td width=2100px>
                ...
                if (strlen($data_schet) == 0) {
                    echo datetostring3($schetfactura_date->date);
                } else {
                    echo $data_schet;
                } ?>
            </td>
        ...
        <tr>
            <td width=2100px>Алушының ЖСК<br/> ИИК получателя<u>   <?php echo $firm->raschetnyy_schet; ?></u> в банке
                <u><?php echo $bank->name . " БИК " . $bank->mfo; ?></u></td>
            <td> (10б)</td>
        </tr>
    </table>
    <br>
    ...
    <table border="1px" width="100%" align="center">
        ...
        <?php endforeach; ?>
        <tr align="center">
            <td width="560px" colspan="5"><b align="left">Барлыгы шот бойынша<br/>Всего по счету:<></b></td>
...
<FONT size=7>
    <table width="100%">
        ...
        <tr>
            <td align="left"><b>Ұйымның бас есепшісі<br/>Главный бухгалтер: <?php echo trim($org->glav_buh); ?> </b>
            </td>
            <td></td>
        ...
        <tr>
            <td align="left"><b>Уполномоченный за подписание счета-фактуры за директора:<br/> инженер по реализации
                    Легких В.Е.</b></td>
            <td></td>
            <td align="right"><b>За главного бухгалтера:<br/> техник по реализации Достанова Б.Б.</b></td>
        </tr>
        <tr>
            <td align="left"></td>
            <td align="right"></td>
        ...
        <tr>
            <td align="left">_____________________________</td>
            <td></td>
            <td align="right">_____________________________</td>
        </tr>
        <tr>
            <td align="left"><font size=6>(Қолы,аты,фамилиясы/Подпись,имя,фамилия)</font></td>
            <td></td>
